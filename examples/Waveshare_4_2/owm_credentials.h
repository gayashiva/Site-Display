...
const char* ssid     = "Surya12";
const char* password = "Icestupa";

// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = "bb48a1b65e1e9823f11a2d9d0c5b30ad";                      // See: https://openweathermap.org/
...
String LAT              = "34.1667";                         // Home location Latitude
String LON              = "77.5833";                         // Home location Longitude

String City             = "LEH";                      // Your home city See: http://bulk.openweathermap.org/sample/
String Country          = "IN";                            // Your _ISO-3166-1_two-letter_country_code country code, on OWM find your nearest city and the country code is displayed
...
const char* Timezone    = "IST-5:30";  // Choose your time zone from: https://github.com/nayarsystems/posix_tz_db/blob/master/zones.csv 
...
int   gmtOffset_sec     = 19800;    // UK normal time is GMT, so GMT Offset is 0, for US (-5Hrs) is typically -18000, AU is typically (+8hrs) 28800
